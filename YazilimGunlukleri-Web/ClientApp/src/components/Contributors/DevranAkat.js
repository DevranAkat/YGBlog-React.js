...
export class DevranAkat extends Component {
  displayName = DevranAkat.name;
  yourName = "Devran Akat";
              ...
              <div class="col-auto">
                <div>
                  <img
                    ...
                    alt="devranlogo"
                    title="Devran Akat Profil Resmi"
                  />
                </div>
              </div>
              <section class="col-auto about">
                ...
                <p class="about-desc">
                  ...
                  <p class="MsoNormal" class="text-justify">
                    <span lang="TR">
                      Ana hedefim yazılım konusunda kendimi geliştirmek ve
                      bildiklerimi paylaşmak. O yüzden Yazılım Günlükleri
                      sayfasını kurdum. Daha fazla bilgi yakında....
                    </span>
                  </p>
                </p>
              </section>
